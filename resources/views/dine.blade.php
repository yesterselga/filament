...
<body class="antialiased">
     <div class="container container-fluid">
          ...
          <div class="row">
               ...
               <div class="col-12">
                    <h1 style="font-size:24px">Table # 1001</h1>
                    <img src="https://cdn.dribbble.com/users/3955123/screenshots/7107983/image.gif" class="img-fluid"
                         alt="...">
                    <span style="font-size:18px;text-align:center;">Hang on! We're preparing your order...</span>
               </div>
          </div>
          ...
          <div class="row">
               <div class="col">
                    ...
                    <button class="btn btn-option" onclick="callWaiter()"><i class="fa fa-person"></i>
                         Call a
                         Waiter</button>

                    <button class="btn btn-option" onclick="viewCart()"><i class="fa fa-receipt"></i>
                         View My Order</button>

                    <button class="btn btn-option" onclick="request()"><i class="fa fa-utensil-spoon"></i>
                         Request for
                         Stuff</button>

                    <button class="btn btn-option" onclick="billOut()"><i class="fas fa-money-bill-alt"></i>
                         Bill Out</button>
          ...
          {{-- <nav class="navbar bottom-action fixed-bottom">
               <div class="container-fluid">
                    ...
                    <a href="#nav-beef" onclick="billOut()"><i class="fa fa-coin"></i> Bill Out</a>
               </div>
          </nav> --}}
     </div>
